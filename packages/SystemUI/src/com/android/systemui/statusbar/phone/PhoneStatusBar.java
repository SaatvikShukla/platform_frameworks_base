...
import com.android.internal.util.io.WeatherController;
import com.android.internal.util.io.WeatherControllerImpl;
import com.android.internal.util.io.WeatherController.WeatherInfo;
...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
        DragDownHelper.DragDownCallback, ActivityStarter, ShakeSensorManager.ShakeListener, OnUnlockMethodChangedListener {
    ...
    // Infinitive logo
    private boolean mInfinitiveLogo;
    private ImageView InfinitiveLogo;
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    ...
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.STATUS_BAR_INFINITIVE_LOGO),
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
        ...
        public void update() {
            ...
            mInfinitiveLogo = Settings.System.getIntForUser(resolver,
                    Settings.System.STATUS_BAR_INFINITIVE_LOGO, 0, mCurrentUserId) == 1;
            showInfinitiveLogo(mInfinitiveLogo);

            mGreeting = Settings.System.getStringForUser(resolver,
					Settings.System.STATUS_BAR_GREETING,
					UserHandle.USER_CURRENT);
			if (mGreeting != null && !TextUtils.isEmpty(mGreeting)) {
				mInfinitiveLabel.setText(mGreeting);
			}
    ...
    protected PhoneStatusBarView makeStatusBarView() {
        ...
        mInfinitiveLabel = (TextView)mStatusBarView.findViewById(R.id.infinitive_custom_label);
        ...
        if ((diff & StatusBarManager.DISABLE_NOTIFICATION_ICONS) != 0) {
            if ((state & StatusBarManager.DISABLE_NOTIFICATION_ICONS) != 0) {
                ...
                if (mGreeting != null && !TextUtils.isEmpty(mGreeting) && mShowLabel) {
					if (animate) {
						mInfinitiveLabel.setVisibility(View.VISIBLE);
						mInfinitiveLabel.animate().cancel();
						mInfinitiveLabel.animate()
								.alpha(1f)
								.setDuration(320)
    ...
    protected void labelAnimatorFadeOut(final boolean animate) {
		...
		mInfinitiveLabel.animate()
			...
			@Override
			public void run() {
				mInfinitiveLabel.setVisibility(View.GONE);
				animateStatusBarShow(mNotificationIconArea, animate);
			}
		});
	}
    ...
    public void showInfinitiveLogo(boolean show) {
        if (mStatusBarView == null) return;
        ContentResolver resolver = mContext.getContentResolver();
        InfinitiveLogo = (ImageView) mStatusBarView.findViewById(R.id.io_logo);
        if (InfinitiveLogo != null) {
            InfinitiveLogo.setVisibility(show ? (mInfinitiveLogo ? View.VISIBLE : View.GONE) : View.GONE);
        }
    }
